 ...
 * 
 */
public class RemoveNonConsicutiveDuplicates {

	public static void main(String[] args) {
		Scanner scnsInp = new Scanner(System.in);
		System.out.println("\nEnter the input text : ");
		String textInput = scnsInp.nextLine();
		System.out.println("\n****** Remove only non-cosicutive repeated charecters *******");
		removeNonConsicutiveRepeatedChars(textInput);
		scnsInp.close();
	}

	private static void removeNonConsicutiveRepeatedChars(String textInput) {
